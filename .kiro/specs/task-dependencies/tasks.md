...
- [ ] 2. Implement dependency addition with validation
  - [ ] 2.1 Implement `addDependency` function with task existence validation
  ...
  - [ ]* 2.2 Write property test for adding dependencies
...
- [ ] 3. Implement dependency removal and cleanup
  ...
  - [ ]* 3.5 Write property test for task deletion cleanup
...
- [ ] 4. Implement dependency queries
  ...
  - [ ]* 4.4 Write property test for dependent queries
