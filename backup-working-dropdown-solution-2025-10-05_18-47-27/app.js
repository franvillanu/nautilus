...
function populateProjectDropdownOptions() {
    const projectOptions = document.getElementById("project-options");
    if (!projectOptions) return;
    
    let optionsHTML = '<div class="project-option" data-project-id="">Select a project</div>';
    
    if (projects && projects.length > 0) {
        optionsHTML += projects.map(project => 
    ...
    projectOptions.innerHTML = optionsHTML;
}
