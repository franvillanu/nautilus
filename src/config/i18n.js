...
export const I18N = {
    en: {
        ...
        'projects.template.saveAsTemplate': 'Save as Template',
        'projects.template.modalTitle': 'Save as Template',
        'projects.template.nameLabel': 'Template name',
        'projects.template.includeTasksLabel': 'Include tasks',
        'projects.template.includeTasksHint': 'Copies all tasks · statuses reset to Backlog · dates cleared',
        'projects.template.saveButton': 'Save Template',
        'projects.template.savedSuccess': 'Template saved',
        'projects.template.deletedSuccess': 'Template deleted',
        'projects.template.renamedSuccess': 'Template renamed',
        'projects.template.deleteModalTitle': 'Delete Template?',
        'projects.template.renameModalTitle': 'Rename Template',
        'projects.template.newNameLabel': 'New name',
        'projects.template.renameButton': 'Rename',
        'projects.modal.templateLabel': 'Start from template',
        'projects.modal.templateNone': 'None',
        'projects.modal.taskNaming': 'Task naming',
        'projects.modal.namingOriginal': 'Original',
        'projects.modal.namingAddPrefix': '+ Prefix',
        'projects.modal.namingAddSuffix': '+ Suffix',
        ...
        'projects.details.resetSort': 'Auto-sort',
        'projects.details.resetSortTitle': 'Reset to automatic sort by priority',
        'projects.untitled': 'Untitled Project',
        'tasks.title': 'All Tasks',
        'tasks.subtitle': 'Manage tasks across all projects',
        'tasks.searchPlaceholder': '\u{1F50D} Search tasks...',
        ...
        'tasks.filters.links': 'Links',
        'tasks.filters.linksTitle': 'Filter by link types',
        'tasks.filters.blocksOthers': 'Blocks others',
        'tasks.filters.isBlockedByOthers': 'Is Blocked by others',
        'tasks.filters.relatesTo': 'Relates to',
        'tasks.filters.hasWebLinks': 'Has Web Links',
        'tasks.filters.noLinks': 'No links',
        'tasks.filters.dateFrom': 'Start date',
        'tasks.filters.dateTo': 'End date',
        'tasks.filters.dateFromLabel': 'From',
        'tasks.filters.dateToLabel': 'To',
        ...
        'filters.chip.emailTasks': 'Email Tasks',
        ...
        'tasks.modal.copyLink': '🔗 Copy link',
        'tasks.modal.linkCopied': 'Link copied to clipboard',
        ...
        'tasks.modal.attachmentsDropzoneDefault': 'Drag & drop or click to attach files (up to 10)',
        'tasks.modal.attachmentsDropzoneTap': 'Tap to attach files (up to 10)',
        ...
        'tasks.links.relatesTo': 'relates to',
        'tasks.links.blocks': 'blocks',
        'tasks.links.isBlockedBy': 'is blocked by',
        'tasks.links.webLink': 'Web link',
        'tasks.links.searchTasks': 'Search tasks...',
        ...
        'calendar.filters.searchProjects': '🔍 Search projects...',
        'calendar.filters.filtersBtn': 'Filters',
        'calendar.filters.clearAll': 'Clear',
        'calendar.filters.panelTitle': 'Filters',
        'calendar.filters.overviewMode': 'Overview mode',
        'calendar.filters.clickDayHint': 'Click a day for the full list',
        'calendar.filters.taskFiltersSummary': 'Tasks: {count} active',
        'calendar.filters.projectFiltersSummary': 'Projects: {count} active',
        'calendar.filters.searchSummary': 'Search: {value}',
        'calendar.filters.dateSummary': 'Date: {value}',
        'calendar.filters.tasksHidden': 'Tasks hidden',
        'calendar.filters.projectsHidden': 'Projects hidden',
        'calendar.agenda.kicker': 'Day agenda',
        'calendar.agenda.emptyTitle': 'Day agenda',
        'calendar.agenda.emptySubtitle': 'Click a day to inspect every visible task and project without expanding the month grid.',
        'calendar.agenda.emptyDay': 'No visible tasks or projects on {date}.',
        'calendar.agenda.close': 'Close day agenda',
        'calendar.agenda.projectCount': '{count} projects',
        'calendar.agenda.taskCount': '{count} tasks',
        'calendar.overflow.moreItems': '+{count} more items this week',
        'calendar.overflow.moreTasks': '+{count} more tasks this week',
        'calendar.overflow.moreProjects': '+{count} more projects this week',
        ...
        'error.tooManyFiles': 'Maximum {max} files per upload. Please select {max} or fewer at a time.',
        ...
        'history.entity.project': 'project',
    ...
    es: {
        ...
        'projects.template.saveAsTemplate': 'Guardar como plantilla',
        'projects.template.modalTitle': 'Guardar como plantilla',
        'projects.template.nameLabel': 'Nombre de plantilla',
        'projects.template.includeTasksLabel': 'Incluir tareas',
        'projects.template.includeTasksHint': 'Copia todas las tareas · estados reiniciados a Pendiente · fechas eliminadas',
        'projects.template.saveButton': 'Guardar plantilla',
        'projects.template.savedSuccess': 'Plantilla guardada',
        'projects.template.deletedSuccess': 'Plantilla eliminada',
        'projects.template.renamedSuccess': 'Plantilla renombrada',
        'projects.template.deleteModalTitle': '¿Eliminar plantilla?',
        'projects.template.renameModalTitle': 'Renombrar plantilla',
        'projects.template.newNameLabel': 'Nuevo nombre',
        'projects.template.renameButton': 'Renombrar',
        'projects.modal.templateLabel': 'Empezar desde plantilla',
        'projects.modal.templateNone': 'Ninguna',
        'projects.modal.taskNaming': 'Nomenclatura',
        'projects.modal.namingOriginal': 'Original',
        'projects.modal.namingAddPrefix': '+ Prefijo',
        'projects.modal.namingAddSuffix': '+ Sufijo',
        ...
        'projects.details.resetSort': 'Orden automático',
        'projects.details.resetSortTitle': 'Restablecer al orden automático por prioridad',
        'projects.untitled': 'Proyecto sin título',
        'tasks.title': 'Todas las tareas',
        'tasks.subtitle': 'Gestiona tareas de todos los proyectos',
        'tasks.searchPlaceholder': '\u{1F50D} Buscar tareas...',
        ...
        'tasks.filters.links': 'Enlaces',
        'tasks.filters.linksTitle': 'Filtrar por tipo de enlace',
        'tasks.filters.blocksOthers': 'Bloquea a otros',
        'tasks.filters.isBlockedByOthers': 'Bloqueado por otros',
        'tasks.filters.relatesTo': 'Relacionado con',
        'tasks.filters.hasWebLinks': 'Tiene enlaces web',
        'tasks.filters.noLinks': 'Sin enlaces',
        'tasks.filters.dateFrom': 'Fecha de inicio',
        'tasks.filters.dateTo': 'Fecha de fin',
        'tasks.filters.dateFromLabel': 'Desde',
        'tasks.filters.dateToLabel': 'Hasta',
        ...
        'filters.chip.emailTasks': 'Tareas del email',
        ...
        'tasks.modal.copyLink': '🔗 Copiar enlace',
        'tasks.modal.linkCopied': 'Enlace copiado al portapapeles',
        ...
        'tasks.modal.attachmentsDropzoneDefault': 'Arrastra y suelta o haz clic para adjuntar (hasta 10)',
        'tasks.modal.attachmentsDropzoneTap': 'Toca para adjuntar (hasta 10)',
        'tasks.modal.linksLabel': 'Enlaces',
        'tasks.modal.attachmentNamePlaceholder': 'Nombre (opcional)',
        'tasks.modal.attachmentUrlPlaceholder': 'URL',
        'tasks.modal.addLink': 'Agregar enlace',
        'tasks.links.relatesTo': 'relacionado con',
        'tasks.links.blocks': 'bloquea',
        'tasks.links.isBlockedBy': 'bloqueado por',
        'tasks.links.webLink': 'Enlace web',
        'tasks.links.searchTasks': 'Buscar tareas...',
        ...
        'calendar.filters.all': 'Todo',
        'calendar.filters.projects': 'Proyectos',
        'calendar.filters.tasks': 'Tareas',
        'calendar.filters.searchProjects': '🔍 Buscar proyectos...',
        'calendar.filters.filtersBtn': 'Filtros',
        'calendar.filters.clearAll': 'Limpiar',
        'calendar.filters.panelTitle': 'Filtros',
        'calendar.filters.overviewMode': 'Modo resumen',
        'calendar.filters.clickDayHint': 'Haz clic en un día para ver la lista completa',
        'calendar.filters.taskFiltersSummary': 'Tareas: {count} activas',
        'calendar.filters.projectFiltersSummary': 'Proyectos: {count} activos',
        'calendar.filters.searchSummary': 'Búsqueda: {value}',
        'calendar.filters.dateSummary': 'Fecha: {value}',
        'calendar.filters.tasksHidden': 'Tareas ocultas',
        'calendar.filters.projectsHidden': 'Proyectos ocultos',
        'calendar.agenda.kicker': 'Agenda del día',
        'calendar.agenda.emptyTitle': 'Agenda del día',
        'calendar.agenda.emptySubtitle': 'Haz clic en un día para revisar todas las tareas y proyectos visibles sin expandir la cuadrícula mensual.',
        'calendar.agenda.emptyDay': 'No hay tareas ni proyectos visibles el {date}.',
        'calendar.agenda.close': 'Cerrar agenda del día',
        'calendar.agenda.projectCount': '{count} proyectos',
        'calendar.agenda.taskCount': '{count} tareas',
        'calendar.overflow.moreItems': '+{count} elementos más esta semana',
        'calendar.overflow.moreTasks': '+{count} tareas más esta semana',
        'calendar.overflow.moreProjects': '+{count} proyectos más esta semana',
        ...
        'error.tooManyFiles': 'Máximo {max} archivos por subida. Por favor, selecciona {max} o menos a la vez.',
        ...
        'history.entity.project': 'proyecto',
