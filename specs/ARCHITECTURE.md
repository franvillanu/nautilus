...
├── auth.js                       # Authentication system (login, PIN/password, forgot-password)
...
│   ├── app.bundle.js             # Bundled app.js + src/ modules
│   └── style.bundle.css          # Bundled style.css
│
├── src/                          # Modular source (bundled into dist/)
│   ├── config/i18n.js            # Translations
│   ├── core/events.js            # Event delegation
│   └── views/projectsView.js     # Projects page view
│
├── lock/                         # Password protection system (LEGACY, replaced by auth.js)
